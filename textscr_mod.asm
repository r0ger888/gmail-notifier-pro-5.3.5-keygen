...
ScrollFont		LOGFONT <8,6,0,0,FW_DONTCARE,0,0,0,DEFAULT_CHARSET,OUT_DEFAULT_PRECIS,CLIP_DEFAULT_PRECIS,\
									DEFAULT_QUALITY	,0,'terminal'>
ScrollText	    		db	"The PERYFERiAH Team is proud to present another fine"
						db  " release :: Gmail Notifier Pro 5.3.5 *kEyGeN* :: gfx by r0ger :: sfx by freefall :: "
						db  "sPecial gr33tZ 2 all my friendz out there incl GRUiA, WeeGee, MaryNello, "
						db  "DAViD, r0ger, B@TRyNU, ShTEFY, s0r3l, sabYn, ShoGun, zzLaTaNN, yMRAN and"
						db  " otherz . But also to all reversing groups who still make quality releas"
						db  "es even this year ! =)                                                       "
						db  "p.s.: fuck da ripperZ, death 2 all Lam3rZ ! :: (c) 2o22",0
...
ScrollerInit proc hWnd:HWND
	...
	m2m scr.scroll_hwnd,hWnd
		...
		mov scr.scroll_x,1
		mov scr.scroll_y,291
		
		mov scr.scroll_width,310
